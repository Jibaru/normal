/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production` (hash: c7ec18a761e5a6189ad5cf3736389cf9)
// Runtime types generated with workerd@1.20260730.1 2026-07-31 nodejs_compat
interface __BaseEnv_Env {
	DELETION_MARKERS: R2Bucket;
	RECIPIENT_TRANSITIONS: R2Bucket;
	DEPLOYMENT_ENVIRONMENT: "production";
	RECOVERY_BRANCH_PREFIX: "recovery/production-";
	RECOVERY_DATABASE_NAME: "neondb";
	DELETION_MARKER_HMAC_SECRET: string;
	NEON_RECOVERY_API_KEY: string;
