/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 982b34e616b8d7cc04bd9a60546642cc)
// Runtime types generated with workerd@1.20260730.1 2026-08-06 global_fetch_strictly_public
interface __BaseEnv_Env {
	ALERT_RECEIPTS: KVNamespace;
	PAGER_EMAIL: SendEmail;
	API_ORIGIN: "https://api.development.example.test" | "https://api.preview.example.test" | "https://api.normal.fast";
	DEPLOYMENT_ENVIRONMENT: "development" | "preview" | "production";
	CLOUDFLARE_ANALYTICS_TOKEN: string;
	CLOUDFLARE_ZONE_ID: string;
	OBSERVABILITY_QUERY_TOKEN: string;
	PAGER_DESTINATION_ADDRESS: string;
	PAGER_RECEIPT_TOKEN: string;
	PAGER_WEBHOOK_TOKEN: string;
	SMOKE_CHECK_SECRET: string;
}
